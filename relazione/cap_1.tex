...
La relazione è stata scritta in \LaTeX\ usando gli editor \href{https://overleaf.com}{\texttt{Overleaf}} e \texttt{TexStudio}; per la corretta formattazione del codice è stato usato il package \texttt{minted}, mentre per i box colorati \texttt{tcolorbox}.

Il progetto è stato versionato usando Git e l'intero codice sorgente è disponibile all'url \url{https://github.com/salvatore-greco/SWE}. Sono state usate due GitHub Action per gestire il deploy su GitHub Pages dei risultati di coverage e per la compilazione del presente documento.
...
Come database è stato scelto \textit{PostgreSQL}, utilizzando le API \textit{JDBC} e il suo relativo driver. \\
Use Case Diagram e Class Diagram seguono lo standard UML e sono stati realizzati col software \textit{StarUML}.\newline
