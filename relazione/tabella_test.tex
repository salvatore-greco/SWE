...
\subsection*{Business Logic Integration test}\label{BL_IT}
\subsubsection*{Classe \texttt{BookIntegrationTest}}\label{BookIntegrationTest}
...
\subsubsection*{Classe \texttt{CardIntegrationTest}}\label{CardIntegrationTest}
...
\subsubsection*{Classe \texttt{EventIntegrationTest}}\label{EventIntegrationTest}
...
\subsubsection*{Classe \texttt{LibraryIntegrationTest}}\label{LibraryIntegrationTest}
...
\subsubsection*{Classe \texttt{LoanIntegrationTest}}\label{LoanIntegrationTest}
...
\subsubsection*{Classe \texttt{BaseIntegrationTest}}\label{BaseIntegrationTest}
...
\subsubsection*{Classe \texttt{BookDAOIntegrationTest}}\label{BookDAOIntegrationTest}
...
\subsubsection*{Classe \texttt{CardDAOIntegrationTest}}\label{CardDAOIntegrationTest}
...
\subsubsection*{Classe \texttt{ConnectionManagerUnitTest}}\label{ConnectionManagerUnitTest}
...
\subsubsection*{Classe \texttt{EventDAOIntegrationTest}}\label{EventDAOIntegrationTest}
...
\subsubsection*{Classe \texttt{LibraryDAOIntegrationTest}}\label{LibraryDAOIntegrationTest}
...
\subsubsection*{Classe \texttt{LoanDAOIntegrationTest}}\label{LoanDAOIntegrationTest}
...
\subsubsection*{Classe \texttt{RoomDAOIntegrationTest}}\label{RoomDAOIntegrationTest}
...
\subsubsection*{Classe \texttt{UserDAOIntegrationTest}}\label{UserDAOIntegrationTest}
...
\subsubsection*{Classe \texttt{StudyRoomIntegrationTest}}\label{StudyRoomIntegrationTest}
...
\subsubsection*{Classe \texttt{AuthUnitTest}}\label{AuthUnitTest}
...
\subsubsection*{Classe \texttt{EventRoomUnitTest}}\label{EventRoomUnitTest}
...
\subsubsection*{Classe \texttt{EventUnitTest}}\label{EventUnitTest}
...
\subsubsection*{Classe \texttt{LoanUnitTest}}\label{LoanUnitTest}
...
\subsubsection*{Classe \texttt{RoomUnitTest}}\label{RoomUnitTest}
...
\subsubsection*{Classe \texttt{StudyRoomUnitTest}}\label{StudyRoomUnitTest}
...
\subsubsection*{Classe \texttt{DBSeederTest}}\label{DBSeederTest}
